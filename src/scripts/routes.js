...
function searchRoutes(){
	var baseUrl = "http://open.mapquestapi.com/directions/v2/route?key=ugu40KSfOnVGSAEm4EZGuwm8vsxyzROR&from=";
	var join = "&to=";
...
function displayRoute(sessionId, lat, lon){
	...
	var baseUrl = "http://www.mapquestapi.com/directions/v2/routeshape?key=ugu40KSfOnVGSAEm4EZGuwm8vsxyzROR"
